                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea x-model="draftTask.title" id="title" rows="1" class="auto-grow block w-full rounded bg-[#3c3c3c] border-[#333] text-[#d4d4d4] focus:border-[#007fd4] focus:ring-[#007fd4] sm:text-sm py-2 px-3 placeholder-[#666]" placeholder="Nombre de la tarea..."></textarea>
                                        ...
                                        <template x-for="(subtask, index) in draftTask.subtasks" :key="subtask.id || subtask._cid || index">
                                            <div class="space-y-2 p-2 bg-[#2d2d2d] rounded border border-[#3c3c3c]">
                                                <div class="flex gap-2 items-center">
                                                    ...
                                                    <textarea x-model="subtask.title" rows="1" placeholder="Título de la subtarea" class="auto-grow block w-full rounded bg-[#3c3c3c] border-[#333] text-[#d4d4d4] focus:border-[#007fd4] focus:ring-[#007fd4] sm:text-sm py-2 px-3 placeholder-[#666]"></textarea>
                                                ...
                                                <textarea x-model="subtask.description" rows="1" placeholder="Detalles de la subtarea (opcional)" class="auto-grow block w-full rounded bg-[#3c3c3c] border-[#333] text-[#9d9d9d] focus:border-[#007fd4] focus:ring-[#007fd4] text-xs py-1.5 px-3 placeholder-[#555]"></textarea>
